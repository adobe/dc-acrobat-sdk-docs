...
(function() {
	...
	function updateFacebookButton() {
		...
		url = 'http://www.facebook.com/plugins/share_button.php?href='+
			  rh.model.get(rh.consts('KEY_TOPIC_URL')) +
	...
	function updateTwitterButton() {
		var holderID, holder, newLink, textNode;
		...
		newLink.setAttribute("data-url", rh.model.get(rh.consts('KEY_TOPIC_URL')));
