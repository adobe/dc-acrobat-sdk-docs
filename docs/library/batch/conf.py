...
project = u'Acrobat and PDFL SDK: Using Batch Sequences'
...
html_title = "Acrobat and PDFL SDK: Using Batch Sequences"

# A shorter title for the navigation bar.  Default is the same as html_title.
# maps to shorttitle|e
html_short_title = "Acrobat and PDFL SDK: Using Batch Sequences"
