...
project = u'Acrobat and PDFL SDK: Accessibility'
...
html_title = "Acrobat and PDFL SDK: Accessibility"

# A shorter title for the navigation bar.  Default is the same as html_title.
# maps to shorttitle|e
html_short_title = "Acrobat and PDFL SDK: Accessibility"
...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \centering
        \vspace*{40mm}
        \textbf{\Huge Acrobat and PDFL SDK: Accessibility}
