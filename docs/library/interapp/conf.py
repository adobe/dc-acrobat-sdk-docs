...
project = u'Acrobat and PDFL SDK: Interapplication Communication'
...
html_title = "Acrobat and PDFL SDK: Interapplication Communication"

# A shorter title for the navigation bar.  Default is the same as html_title.
# maps to shorttitle|e
html_short_title = "Acrobat and PDFL SDK: Interapplication Communication"
